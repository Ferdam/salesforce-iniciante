...
- [1. Guide para Iniciar em Salesforce (Atualizado 2025)](#1-guide-para-iniciar-em-salesforce-atualizado-2025)
  ...
  - [1.6. O que está em alta hoje?](#16-o-que-mudou-nos-últimos-anos)
    - [1.6.1. Einstein GPT e AI Cloud](#161-einstein-gpt-e-ai-cloud)
    - [1.6.2. Agentforce](#162-agentforce---a-nova-era-dos-agentes-autônomos)
    - [1.6.3. Data Cloud](#163-data-cloud---o-coração-dos-dados)
